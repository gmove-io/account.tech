...
//     upgrade_policies::new_upgrade(&mut proposal, @0x1, b"", DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     upgrade_policies::new_restrict(&mut proposal, @0x1, 0, 128, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     upgrade_policies::new_restrict(&mut proposal, @0x1, 0, 192, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     upgrade_policies::new_restrict(&mut proposal, @0x1, 0, 255, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     upgrade_policies::new_restrict(&mut proposal, @0x1, 0, 0, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     upgrade_policies::new_restrict(&mut proposal, @0x1, 0, 1, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
