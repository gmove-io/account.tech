...
//     acc_kiosk::new_take(&mut proposal, ids.pop_back(), OWNER, DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     acc_kiosk::new_list(&mut proposal, ids.pop_back(), 100, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
...
//     let mut proposal = create_dummy_proposal(&mut scenario, &mut account, &extensions);
//     acc_kiosk::new_take(&mut proposal, ids.pop_back(), ALICE, DummyIntent());
//     account.add_proposal(proposal, version::current(), DummyIntent());
